...
var KTApexChartsDemo = function () {
	...
	var _demo13 = function () {
		...
		var options = {
			...
			labels: ['Area Head', 'Sales Manager', 'City Head', 'Regional Head', 'Assistant Director ', 'Deputy Director'],
			colors: [primary, success, warning, danger, info, warning ]
		};
