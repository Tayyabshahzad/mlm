            ...
            if (response.success) {
                var userDetails = `
                    <table class='table table-bordered'>
                        ...
                        <tr> <td> Joined </td> <td> ${response.data.created_at}</td> </tr>
                        <tr> <td> Status </td> <td> ${response.data.status}</td> </tr> 
                        <tr> <td> Transaction Id </td> <td> ${response.data.transaction_id}</td> </tr> 
                        <tr> <td> Payment Method </td> <td> ${response.data.payment_method}</td> </tr> 
                        <tr> <td> Activation Code </td> <td> ${response.data.activationCode.code}</td> </tr> 
                        <tr> <td> Code Generated By</td> <td> ${response.data.activationCode.generated_by}</td> </tr> 
                        <tr> <td> Refer By</td> <td> <a href="/users/info/${response.data.referBy.id}">${response.data.referBy.username}</a></td></tr>

                        <tr class="text-center bg-light-danger"> <td colspan="2" align="center"> Payment Information </td> </tr>  
                        <tr> <td> Transferred Amount PKR </td> <td> ${response.data.transferred_amount}</td> </tr>  
                        <tr> <td> Total USDT Paid</td> <td> ${response.data.converted_usdt_amount}</td> </tr>  
                        <tr> <td> Fee Deducted  </td> <td> ${response.data.fee_deducted}</td> </tr>  
                        <tr> <td> Net Invested USDT </td> <td> ${response.data.net_invested_usdt_amount}</td> </tr>  
                        <tr> <td> USDT Rate </td> <td> ${response.data.usdt_rate}</td> </tr>  
                        <tr> <td> Created At </td> <td> ${response.data.created_at}</td> </tr>  
                    </table>
                `;
                if (response.data.amount_proof) {
                    ...
                    <table class='table table-bordered'>
                        ...
                        <tr> <td> <img src="${response.data.amount_proof}" alt="Amount Proof Image"  class="img img-thumbnail"style="max-width: 100%; height: auto;" /> </td>  </tr> 
                    </table>
