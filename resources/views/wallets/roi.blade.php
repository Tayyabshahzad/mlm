                        ...
                        <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                            ...
                            <tbody>
                                ...
                                <tr class="pl-0">
                                    ...
                                    <td>
                                        <a class="text-dark-75 font-weight-bolder d-block font-size-sm">Jan</a> 
                                    </td>   
                                    <td>
                                ...
                                <tr class="pl-0">
                                    ...
                                    <td>
                                        <a class="text-dark-75 font-weight-bolder d-block font-size-sm">Feb</a> 
                                    </td>   
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-sm">3%</span> 
                                    </td> 
                                    <td>
