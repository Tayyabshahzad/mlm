        ...
        <div class="  flex-column-fluid">
            <div class="container">
                <div class="col-lg-12 col-xxl-12 order-1 order-xxl-2"> 
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">${{ $totalInvest }}</span>
                                            <span class="font-weight-bold text-muted font-size-sm">Total Investment</span>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Stats Widget 29-->
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-danger card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">${{ $lastInvest->amount }}</span>
                                            <span class="font-weight-bold text-white font-size-sm">Last Investment</span>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                    <!--end::Stats Widget 31-->
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header border-0">
                            <h3 class="card-title font-weight-bolder text-dark">Investments</h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="mb-10">
                                    ...
                                    <table class="table table-head-custom table-vertical-center"
                                        ...
                                        @foreach($investments as $investment)
                                            <tr class="pl-0 @if($investment->investment_from) bg-light-danger @endif">
                                                ...
                                                <td>
                                                    <a class="text-dark-75 font-weight-bolder d-block font-size-sm">{{ $investment->amount    }}</a> 
                                                </td>   
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-sm text-warning ">{{ ucfirst($investment->type) }} </span>  
                                                </td> 

                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-sm text-warning ">{{ ucfirst($investment->description) }} </span>  
                                                </td>  
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-sm">{{ $investment->created_at->format('d-m-Y') }}</span> 
                                                </td>  
                                            </tr>  
                                        @endforeach
                                    </table>
