                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr> 
                                                        ...
                                                        <th class="text-left pr-0 font-weight-bold text-muted text-uppercase">Photo</th> 
                                                        <th class="text-left font-weight-bold text-muted text-uppercase">Price PV</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="font-weight-boldest"> 
                                                        ...
                                                        <td class="text-left pt-7 align-middle">{{ $product->name }}</td>

                                                        <td class="border-0 pl-0 pt-7 d-flex align-items-center"> 
                                                            <div class="symbol symbol-40 flex-shrink-0 mr-4 bg-light">
                                                                <div class="symbol-label"    style="background-image: url('{{asset($product->getFirstMediaUrl('product_cover')) }}')"></div>
                                                            </div>
                                                        </td>
                                                        <td class="text-left pt-7 align-middle">{{ $product->price }}</td> 
                                                        <td class="text-primary pr-0 pt-7 text-left align-middle">
                                                            ...
                                                            @endif
                                                            data-id="{{ $product->id }}"
                                                            class="radius btn btn-sm {{  $product->is_active == true ? 'btn-outline-success' : 'btn-outline-danger' }}"> 
                                                            {{ $product->is_active == true ? 'Active ' : 'In Active' }} 
                                                        </button>
                                                        </td>
                                                        <td class="text-left pt-7 align-middle"> 
                                                            <a href='{{ route('product.update.view',$product->id) }}' class="btn btn-sm btn-outline-warning">Update</a> 
